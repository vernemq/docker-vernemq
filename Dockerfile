...
# subscription.
ARG TARGETARCH
ARG VERNEMQ_TARBALL_URL="https://github.com/vernemq/vernemq/releases/download/$VERNEMQ_VERSION/vernemq-$VERNEMQ_VERSION.trixie.${TARGETARCH/amd64/x86_64}.tar.gz"
